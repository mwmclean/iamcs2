...
```
## Error: error in evaluating the argument 'x' in selecting a method for function 'print': Error: object 'myGp' not found
```
</td>
...
<p><cite>Garcia, T. P, S. Müller, R. J. Carroll, et al.
(2013).
&ldquo;Identification of important regressor groups, subgroups and individuals via regularization methods: application to gut microbiome data&rdquo;.
In: <em>Bioinformatics</em> 608.
DOI: <a href="http://dx.doi.org/10.1093/bioinformatics/btt608">10.1093/bioinformatics/btt608</a>.</cite></p>

<p><cite>Jennings, E. M, J. S. Morris, R. J. Carroll, et al.
(2013).
&ldquo;Bayesian methods for expression-based integration of various types of genomics data&rdquo;.
In: <em>EURASIP Journal on Bioinformatics and Systems Biology</em> 2013.1, pp. 1&ndash;11.
URL: <a href="http://bsb.eurasipjournals.com/content/2013/1/13">http://bsb.eurasipjournals.com/content/2013/1/13</a> (visited on Feb. 02, 2014).</cite></p>
...
<p><cite>Baez, John C. and Aaron D. Lauda
(2004a).
&ldquo;Higher-Dimensional Algebra V: 2-Groups&rdquo;.
Version 3.
In: <em>Theory and Applications of Categories</em> 12, pp. 423-491.
arXiv: <a href="http://arxiv.org/abs/math/0307200v3">math/0307200v3</a>.</cite></p>

<p><cite>&mdash;
(2004b).
<em>Higher-Dimensional Algebra V: 2-Groups</em>.
arXiv: <a href="http://arxiv.org/abs/math/0307200v3">math/0307200v3</a>.</cite></p>
...
<p><a id='bib-itzhaki'></a><a href="#cite-itzhaki">[1]</a><cite>
N. Itzhaki.
<em>Some remarks on 't Hooft's S-matrix for black holes</em>.
Mar. 11, 1996.
arXiv: <a href="http://arxiv.org/abs/hep-th/9603067">hep-th/9603067</a>.</cite></p>

<p><a id='bib-loh'></a><a href="#cite-loh">[2]</a><cite>
N. C. Loh.
&ldquo;High-Resolution Micromachined Interferometric Accelerometer&rdquo;.
MA Thesis.
Cambridge, Mass.: Massachusetts Institute of Technology, 1992.</cite></p>

<p><a id='bib-wilde'></a><a href="#cite-wilde">[3]</a><cite>
O. Wilde.
<em>The Importance of Being Earnest: A Trivial Comedy for Serious
People</em>.
English and American drama of the Nineteenth Century.
Leonard Smithers and Company, 1899.
Google Books: googlebooks.</cite></p>
